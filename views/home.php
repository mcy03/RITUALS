...
<div class="div-body">
    ...
    <section class="slide">
        <div class="slide-inner">
            ...
            <div class="slide-item">
                <div>
                    <h3>A TU SERVICIO</h3>
                    <p>Entrega gratis a pedidos con 2 o más artículos</p>
                </div>
            </div>
    ...
    <section class="publi-entradas d-flex justify-content-around">
        <div class="publi card">
            <div class="card-body">
                ...
                <a href="#" class="boton-simple btn btn-primary">COMPRAR AHORA</a>
            </div>
            <img src="img/cocteleria.jfif" class="card-img-top" alt="...">
        </div>
        <div class="publi card">
            <div class="card-body">
            ...
            <img src="img/anunciosHome.jpg" class="card-img-top" alt="...">
        </div>
    </section>
        ...
        <?php foreach($productos_cat_a as $productosA){?>
            <div class="cartaProducto card">
                <div class="containerProduct">
                    <img src="<?=$productosA->getImg()?>" class="card-img-top" alt="img/coctelX.png">
                </div>
                <div class="bodyProduct card-body">
                    ...
                    <div class= "priceCarrito">
                        ...
                        <a href="#"><img src="img/boton_carrito.png" alt="boton añadir" class="addButton"></a>
                    </div>
                </div>
            </div>
        <?php } ?>
    ...
    <section class="publi-entradas d-flex justify-content-around">
        <div class="publi card">
            ...
            <img src="img/imgSeccionPubli1.png" class="card-img-top" alt="...">
        </div>
        <div class="publi card">
            <div class="card-body">
            ...
            <img src="img/imgSeccionPubli2.jpg" class="card-img-top" alt="...">
        </div>
    </section>
    ...
    <section class="slider-categorias">
        ...
        <?php foreach($productos_cat_b as $productosB){?>
            <div class="cartaProducto card">
                <div class="containerProduct">
                    <img src="<?=$productosB->getImg()?>" class="card-img-top" alt="img/coctelX.png">
                </div>
                <div class="bodyProduct card-body">
